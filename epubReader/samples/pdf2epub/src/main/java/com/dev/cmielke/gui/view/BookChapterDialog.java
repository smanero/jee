 ...
 * 
 * @author Rafthrasa
 * @deprecated This class is no longer used! Use BookChapterDialog of package com.dev.cmielke.gui.dialogs
 */
...
public class BookChapterDialog extends JDialog {
	...
	private JComboBox formatType = new JComboBox(new DefaultComboBoxModel(new Object[] { ChapterFormat.TEXT, ChapterFormat.PREFORMATED, ChapterFormat.ZEITTAFEL, ChapterFormat.GLOSSAR }));
	...
	public static boolean editChapter(JFrame parent, PerryRhodanBook book, String orginalFilename) {
		BookChapterDialog dialog = new BookChapterDialog(parent, rBundle.getString("BookDialog.titel") + "  " + orginalFilename, book);
