...
public class SpeechAligner {
    ...
    public List<WordResult> align(URL audioUrl, List<String> sentenceTranscript) throws IOException {
        ...
        LongTextAligner aligner = null;
        if (TUPLE_SIZE > transcript.size()) aligner = new LongTextAligner(transcript, transcript.size());
        else aligner = new LongTextAligner(transcript, TUPLE_SIZE);
